...
int main(int argc, char** argv) {
    ...
    int extraEdges = atoi(argv[5]);
    int maxHotels  = atoi(argv[6]);
    cerr << maxHotels << endl;
    ...
    cout << "(define (problem " << argv[7] << ")" << endl;
    ++spaceLevel;
    printSpaces();
    ...
    << ") (= (spent-days) 0) (= (min-days-viatge) " << minDiesViatge << ") (= (sum-interest) 0)" << endl;
    cout << endl;
    ----spaceLevel;
    printSpaces();
    cout << ")" << endl;
    printSpaces();
    cout << "(:goal (<= (min-days-viatge) 0))" << endl;
    printSpaces();
    cout << "(:metric minimize (sum-interest))" << endl;
    --spaceLevel;
    printSpaces();
    cout << ")" << endl;
